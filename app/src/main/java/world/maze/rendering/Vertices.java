...
//		mPositionHandle = AttribVariable.A_Position.getHandle();
		mTextureCoordinateHandle = GLES20.glGetAttribLocation(AppSettings.oglTextRenderProgram, ShaderHelper.TEXTURE_COORDINATE_ATTRIBUTE);
		mMVPIndexHandle = GLES20.glGetAttribLocation(AppSettings.oglTextRenderProgram, ShaderHelper.MVP_MATRIX_INDEX_ATTRIBUTE);
		mPositionHandle = GLES20.glGetAttribLocation(AppSettings.oglTextRenderProgram, ShaderHelper.POSITION_ATTRIBUTE);
	}
